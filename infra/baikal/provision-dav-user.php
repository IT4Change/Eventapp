 ...
 * then inserts a DAV principal + auth user + default addressbook/calendar.
 *
 * Executed inside the baikal container (as the nginx user):
 *   docker compose exec --user nginx baikal php /tmp/provision-dav-user.php
 *
 * Args (all optional, defaults shown):
 *   $1 username = admin   $2 password = admin
 *   $3 email = admin@example.com   $4 displayname = Admin
 *
 * (Adapted from webcraftmedia/jahrweiser.)
 */
...
echo "[provision] DAV user '$username' ready (password: '$password')\n";
